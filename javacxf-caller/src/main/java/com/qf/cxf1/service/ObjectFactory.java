 ...
 * generated in the com.qf.cxf1.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://service.cxf1.qf.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.cxf1.qf.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.qf.cxf1.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf1.qf.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cxf1.qf.com/", name = "queryWeatherResponse")
