 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceImplService", targetNamespace = "http://impl.service.ws.ttshop.qf.com/", wsdlLocation = "http://127.0.0.1:90/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACEIMPLSERVICE_QNAME = new QName("http://impl.service.ws.ttshop.qf.com/", "WeatherInterfaceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:90/weather?wsdl");
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort() {
        return super.getPort(new QName("http://impl.service.ws.ttshop.qf.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class);
    }
    ...
    public WeatherInterfaceImpl getWeatherInterfaceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.ws.ttshop.qf.com/", "WeatherInterfaceImplPort"), WeatherInterfaceImpl.class, features);
    }
