 ...
 * generated in the com.qf.ttshop.ws.service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://impl.service.ws.ttshop.qf.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.service.ws.ttshop.qf.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.qf.ttshop.ws.service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.ttshop.qf.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.ttshop.qf.com/", name = "queryWeatherResponse")
