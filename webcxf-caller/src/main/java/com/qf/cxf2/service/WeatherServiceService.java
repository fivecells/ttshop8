 ...
 * 2018-01-31T15:01:27.093+08:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "WeatherServiceService", 
                  wsdlLocation = "http://localhost:99/pub/ws/weather?wsdl",
                  targetNamespace = "http://service.cxf2.qf.com/") 
public class WeatherServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.cxf2.qf.com/", "WeatherServiceService");
    public final static QName WeatherServicePort = new QName("http://service.cxf2.qf.com/", "WeatherServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:99/pub/ws/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:99/pub/ws/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
